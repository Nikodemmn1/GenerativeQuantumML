...
class PokemonConvVAEEncoder(nn.Module):
    def __init__(self, latent_size, noise_std):
        ...
        self.conv_encoder = nn.Sequential(
            nn.Conv2d(channels_in_image, conv_out_channels[0], kernel_size=conv_kernel_sizes[0], stride=(2, 2)),
...
class PokemonConvVAE(nn.Module):
    def __init__(self, latent_size, noise_std):
        ...
        self.encoder = PokemonConvVAEEncoder(latent_size, noise_std)
        self.decoder = PokemonConvVAEDecoder(latent_size)
